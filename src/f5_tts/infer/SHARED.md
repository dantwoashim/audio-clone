...
- [Arabic](#arabic)
    - [F5-TTS Small @ ar & en @ SILMA](#f5-tts-small--ar--en--silma)
- [English](#english)
- [Finnish](#finnish)
...
#### F5-TTS Small @ ar & en @ SILMA
|Model|🤗Hugging Face|Data (Hours)|Model License|
|:---:|:------------:|:-----------:|:-------------:|
|F5-TTS Small|community checkpoint and vocab package| Tens of thousands EN/AR |Apache-2.0|

- Pretrained by SILMA
- Community inference repository available from the original publisher
